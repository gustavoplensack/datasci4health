...
# Conclusão
Nosso trabalho buscou analisar a correlação entre o nível de isolamento social praticado no estado de SP e nos DRSs com indicadores de empregabilidade da PNAD e CAGED. Foi observado uma correlação importante entre o isolamento social no estado de SP e o número de pessoas ocupadas, assim como com os diferentes setores da economia no estado, principalmente relacionados ao comércio, indústria, alimentação/hospedagem, construção e informação.  Também constatamos que cada DRS apresentou correlação diferente entre o nível de isolamento praticado e número de admissões e saldo na região, o que pode ser explicado pelos diferentes níveis de isolamento assim como se a sua principal atividade econômica. CAGED e PNAD avaliam a empregabilidade de maneiras diferentes, o que não permite comparação entre eles, também é esperado que não sofram a mesma influência do isolamento social. Enquanto os dados do PNAD indicam que o total de pessoas empregadas reduziu à medida que o isolamento aumentou, o CAGED indica que o isolamento social afetou não apenas o total de pessoas na ativa (saldo) como também o total de contratações (admissões). Nosso estudo permitiu uma análise inicial sobre o tema, e considerando que a relação entre isolamento social e empregabilidade sofrem influência de diversos aspectos aqui não estudados em profundidade, novos estudos devem englobar estas características analisando eventuais efeitos moderadores nesta relação como recebimento de auxílio emergencial, indicadores econômicos, nível de ocupação de UTIs e incidência da doença na região. 
